...
tinymce.PluginManager.add('responsivefilemanager', function(editor) {
	...
	if (typeof editor.settings.filemanager_descending !== "undefined" && editor.settings.filemanager_descending)
        ...
        win = editor.windowManager.open({
            title: title,
            file: editor.settings.external_filemanager_path+'dialog.php?type=4&akey='+editor.settings.filemanager_access_key+'&descending='+descending+'&sort_by='+sort_by+'&lang='+editor.settings.language,
            width: 860,
            height: 570,
            inline: 1,
	    resizable: true,
